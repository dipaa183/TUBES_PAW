...
<body class="container pt-4">
    ...
    <div class="mb-4">
        ...
        <a href="../../backend/export/export_pdf.php" class="btn btn-danger me-2"><i class="fas fa-file-pdf me-1"></i>
            PDF</a>
        <a href="../../backend/export/export_excel.php" class="btn btn-success"><i class="fas fa-file-excel me-1"></i>
            Excel</a>
    </div>
